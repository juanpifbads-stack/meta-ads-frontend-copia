...
export const CLIENTS = {
  moka: {
    ...
    strategicProducts: [
      { sku: 'CAT-00204', name: 'Cardigan Scylla' },
      { sku: 'CAT-00206', name: 'Cardigan Ariadne Negro Único' },
      { sku: 'CHT-00063', name: 'Chaleco Perseo' },
      { sku: 'CHT-00065', name: 'Chaleco Dédalo' },
      { sku: 'CHT-00066', name: 'Chaleco Harpy' },
      { sku: 'CHT-00073', name: 'Chaleco Makis' },
      { sku: 'FAT-00023', name: 'Falda Nyx' },
      { sku: 'MUT-00099', name: 'Musculosa Demeter' },
      { sku: 'POT-00085', name: 'Polera Erebo' },
      { sku: 'POT-00086', name: 'Polera Lemuria' },
      { sku: 'SWE-00465', name: 'Sweater Hestia' },
      { sku: 'SWE-00468', name: 'Sweater Reah' },
      { sku: 'SWE-00469', name: 'Sweater Febe' },
      { sku: 'SWE-00470', name: 'Sweater Hiperion' },
      { sku: 'SWE-00477', name: 'Sweater Iasis' },
      { sku: 'SWE-00488', name: 'Sweater Talos' },
      { sku: 'SWE-00490', name: 'Sweater Atropos' },
      { sku: 'SWE-00498', name: 'Sweater Eurydice' },
      { sku: 'SWE-00500', name: 'Sweater Chryseis' },
      { sku: 'SWE-00503', name: 'Sweater Skylla' },
      { sku: 'SWE-00508', name: 'Sweater Mytikas' },
      { sku: 'SWE-00509', name: 'Sweater Geras' },
      { sku: 'SWE-00510', name: 'Sweater Deimos' },
      { sku: 'SWE-00511', name: 'Sweater Hypate' },
      { sku: 'SWE-00512', name: 'Sweater Estigia' },
      { sku: 'SWE-00517', name: 'Sweater Athenis' },
      { sku: 'SWE-00518', name: 'Sweater Manolis' },
      { sku: 'SWE-00522', name: 'Sweater Aris' },
      { sku: 'SWE-00535', name: 'Sweater Alkyone' },
      { sku: 'SWE-00550', name: 'Sweater Telus' },
      { sku: 'SWE-00573', name: 'Sweater Nexus' },
      { sku: 'SWE-00581', name: 'Sweater Nami' },
    ],
